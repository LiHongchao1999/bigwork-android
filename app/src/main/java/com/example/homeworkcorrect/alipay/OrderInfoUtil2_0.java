...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2) {
		...
		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+ UserCache.clapMoneyNum+"\",\"subject\":\"20210505\",\"body\":\"充值拍拍币\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
