...
public class ShowCircleImagesDialog extends Dialog {
    private View mView ;
    ...
    private int current;
    public ShowCircleImagesDialog(@NonNull Context context, List<String> imgUrls, int i) {
    ...
    private void initData() {
        ...
        for (int i = 0; i < mImgUrls.size(); i++) {
            ...
            Glide.with(mContext)
                    .load(IP.CONSTANT+"circleImage/"+mImgUrls.get(i))
